...
export type AbilityId = 'extraCore' | 'recruiter' | 'poison' | 'autoGun' | 'overcharge' | 'splitAll' | 'sacrifice' | 'bossMagnet' | 'ballRestore' | 'critical' | 'paintShot' | 'energyEcho' | 'foreverRainbow';
